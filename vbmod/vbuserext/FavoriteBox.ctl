...
Private Const DEFAULT_INVISIBLEATRUNTIME = True
...
Private m_InvisibleAtRuntime As Boolean
...
Public Property Get InvisibleAtRuntime() As Boolean
    InvisibleAtRuntime = m_InvisibleAtRuntime
End Property
Public Property Let InvisibleAtRuntime(ByVal newval As Boolean)
    m_InvisibleAtRuntime = newval
End Property
...
Private Sub UserControl_InitProperties()
    m_InvisibleAtRuntime = DEFAULT_INVISIBLEATRUNTIME
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    m_InvisibleAtRuntime = PropBag.ReadProperty("InvisibleAtRuntime", DEFAULT_INVISIBLEATRUNTIME)
...
Private Sub UserControl_Show()
    If m_InvisibleAtRuntime And Ambient.UserMode Then
        UserControl.Width = 0
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    PropBag.WriteProperty "InvisibleAtRuntime", m_InvisibleAtRuntime
