...
static mxChar _array7_[9] = { 'f', '_', 'a', 'i', '_', 'f', 'u', 'n', 'c' };
static mxArray * _mxarray6_;

static mxChar _array9_[6] = { 'f', '_', 'a', 'i', '_', 'i' };
static mxArray * _mxarray8_;

static mxChar _array11_[6] = { 'f', '_', 'a', 'i', '_', 'T' };
static mxArray * _mxarray10_;

static mxChar _array13_[8] = { 'f', '_', 'a', 'i', '_', 'o', 'm', 'g' };
static mxArray * _mxarray12_;

void InitializeModule_f_ai_function(void) {
...
void TerminateModule_f_ai_function(void) {
...
static mxArray * Mf_ai_function(int nargout_, mxArray * x);

_mexLocalFunctionTable _local_function_table_f_ai_function
  = { 0, (mexFunctionTableEntry *)NULL };

/*
 * The function "mlfF_ai_function" contains the normal interface for the
 * "f_ai_function" M-function from file "d:\M6\work\f_ai_function.m" (lines
 * 1-8). This function processes any input arguments and passes them to the
 * implementation version of the function, appearing above.
 */
mxArray * mlfF_ai_function(mxArray * x) {
    int nargout = 1;
    mxArray * out = mclGetUninitializedArray();
    mlfEnterNewContext(0, 1, x);
    out = Mf_ai_function(nargout, x);
    mlfRestorePreviousContext(0, 1, x);
    return mlfReturnValue(out);
}

/*
 * The function "mlxF_ai_function" contains the feval interface for the
 * "f_ai_function" M-function from file "d:\M6\work\f_ai_function.m" (lines
 * 1-8). The feval function calls the implementation version of f_ai_function
 * through this function. This function processes any input arguments and
 * passes them to the implementation version of the function, appearing above.
 */
void mlxF_ai_function(int nlhs, mxArray * plhs[], int nrhs, mxArray * prhs[]) {
    mxArray * mprhs[1];
    mxArray * mplhs[1];
    int i;
    if (nlhs > 1) {
    ...
    mplhs[0] = Mf_ai_function(nlhs, mprhs[0]);
    mlfRestorePreviousContext(0, 1, mprhs[0]);
    plhs[0] = mplhs[0];
}

/*
 * The function "Mf_ai_function" is the implementation version of the
 * "f_ai_function" M-function from file "d:\M6\work\f_ai_function.m" (lines
...
static mxArray * Mf_ai_function(int nargout_, mxArray * x) {
    mexLocalFunctionTable save_local_function_table_
      = mclSetCurrentLocalFunctionTable(&_local_function_table_f_ai_function);
    mxArray * out = mclGetUninitializedArray();
    ...
    mclValidateOutput(out, 1, nargout_, "out", "f_ai_function");
    mxDestroyArray(func);
    mxDestroyArray(i);
    mxDestroyArray(T);
    mxDestroyArray(omg);
