...
static mexFunctionTableEntry function_table[1]
  = { { "f_bi_function", mlxF_bi_function, 1, 1,
        &_local_function_table_f_bi_function } };

static _mexInitTermTableEntry init_term_table[1]
  = { { InitializeModule_f_bi_function, TerminateModule_f_bi_function } };
 ...
 * "mlxF_bi_function". Finally, it clears the feval table and exits.
 */
