...
static mxChar _array13_[9] = { 'f', '_', 'a', 'i', '_', 'f', 'u', 'n', 'c' };
static mxArray * _mxarray12_;

static mxChar _array15_[6] = { 'f', '_', 'a', 'i', '_', 'i' };
static mxArray * _mxarray14_;

static mxChar _array17_[6] = { 'f', '_', 'a', 'i', '_', 'T' };
static mxArray * _mxarray16_;

static mxChar _array19_[8] = { 'f', '_', 'a', 'i', '_', 'o', 'm', 'g' };
static mxArray * _mxarray18_;

static mxChar _array21_[13] = { 'f', '_', 'a', 'i', '_', 'f', 'u',
                                'n', 'c', 't', 'i', 'o', 'n' };
static mxArray * _mxarray20_;

void InitializeModule_f_ai(void) {
...
void TerminateModule_f_ai(void) {
...
static mxArray * Mf_ai(int nargout_, mxArray * func, mxArray * i, mxArray * T);

_mexLocalFunctionTable _local_function_table_f_ai
  = { 0, (mexFunctionTableEntry *)NULL };

/*
 * The function "mlfF_ai" contains the normal interface for the "f_ai"
 * M-function from file "d:\M6\work\f_ai.m" (lines 1-18). This function
 * processes any input arguments and passes them to the implementation version
 * of the function, appearing above.
 */
mxArray * mlfF_ai(mxArray * func, mxArray * i, mxArray * T) {
    int nargout = 1;
    mxArray * out = mclGetUninitializedArray();
    mlfEnterNewContext(0, 3, func, i, T);
    out = Mf_ai(nargout, func, i, T);
    mlfRestorePreviousContext(0, 3, func, i, T);
    return mlfReturnValue(out);
}

/*
 * The function "mlxF_ai" contains the feval interface for the "f_ai"
 * M-function from file "d:\M6\work\f_ai.m" (lines 1-18). The feval function
 * calls the implementation version of f_ai through this function. This
 * function processes any input arguments and passes them to the implementation
 * version of the function, appearing above.
 */
void mlxF_ai(int nlhs, mxArray * plhs[], int nrhs, mxArray * prhs[]) {
    mxArray * mprhs[3];
    mxArray * mplhs[1];
    int i;
    if (nlhs > 1) {
    ...
    mplhs[0] = Mf_ai(nlhs, mprhs[0], mprhs[1], mprhs[2]);
    mlfRestorePreviousContext(0, 3, mprhs[0], mprhs[1], mprhs[2]);
    plhs[0] = mplhs[0];
}

/*
 * The function "Mf_ai" is the implementation version of the "f_ai" M-function
 * from file "d:\M6\work\f_ai.m" (lines 1-18). It contains the actual compiled
...
static mxArray * Mf_ai(int nargout_, mxArray * func, mxArray * i, mxArray * T) {
    mexLocalFunctionTable save_local_function_table_
      = mclSetCurrentLocalFunctionTable(&_local_function_table_f_ai);
    mxArray * out = mclGetUninitializedArray();
    ...
    mclValidateOutput(out, 1, nargout_, "out", "f_ai");
    mxDestroyArray(omg);
    mxDestroyArray(sym);
    mxDestroyArray(x);
    mxDestroyArray(int0);
