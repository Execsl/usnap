...
/* Object interface: IBase64, ver. 0.0,
   GUID={0xA051359F,0xBF80,0x4014,{0xB5,0x0D,0x74,0xC5,0x97,0xCB,0x0F,0xE4}} */
...
CINTERFACE_PROXY_VTABLE(18) _IBase64ProxyVtbl = 
{
    &IBase64_ProxyInfo,
    &IID_IBase64,
    ...
    (void *)-1 /* IBase64::ReadFile */ ,
    (void *)-1 /* IBase64::WriteFile */ ,
    (void *)-1 /* IBase64::get_Size */
};
...
/* 108 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 110 */	NdrFcShort( 0x2c ),	/* Type Offset=44 */
...
#ifndef _ALPHA_
/* 330 */	NdrFcShort( 0x10 ),	/* x86, MIPS, PPC Stack size/offset = 16 */
#else
			NdrFcShort( 0x20 ),	/* Alpha Stack size/offset = 32 */
#endif
/* 332 */	0x8,		/* FC_LONG */
...
#ifndef _ALPHA_
/* 342 */	NdrFcShort( 0x18 ),	/* x86, MIPS, PPC Stack size/offset = 24 */
#else
			NdrFcShort( 0x30 ),	/* Alpha Stack size/offset = 48 */
#endif
/* 344 */	0x8,		/* FC_LONG */
...
const CInterfaceProxyVtbl * _binary_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IBase64ProxyVtbl,
    0
};

const CInterfaceStubVtbl * _binary_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IBase64StubVtbl,
    0
};

PCInterfaceName const _binary_InterfaceNamesList[] = 
{
    "IBase64",
    0
};

const IID *  _binary_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _binary_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _binary, pIID, n)

int __stdcall _binary_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_binary_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo binary_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _binary_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _binary_StubVtblList,
    (const PCInterfaceName * ) & _binary_InterfaceNamesList,
    (const IID ** ) & _binary_BaseIIDList,
    & _binary_IID_Lookup, 
    1,
    2,
