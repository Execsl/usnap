...
void CTestDlg::OnButtonA() 
{
	// TODO: Add your control notification handler code here
	char buf[1000]; 
	sprintf(buf, "%x (%d) \"%s\"", (LPCTSTR)m_a, (LPCTSTR)m_a, (LPCTSTR)m_a); 
	MessageBox(buf); 
}

void CTestDlg::OnButtonB() 
{
	// TODO: Add your control notification handler code here
	char buf[1000]; 
	sprintf(buf, "%x (%d) \"%s\"", (LPCTSTR)m_b, (LPCTSTR)m_b, (LPCTSTR)m_b); 
	MessageBox(buf); 
}

void CTestDlg::OnButtonC() 
{
	// TODO: Add your control notification handler code here
	char buf[1000]; 
	sprintf(buf, "%x (%d) \"%x (%d)\"", &m_c, &m_c, m_c, m_c); 
	MessageBox(buf); 
}

void CTestDlg::OnButtonD() 
{
	// TODO: Add your control notification handler code here
	char buf[1000]; 
	sprintf(buf, "%x (%d) \"%x (%d)\"", &m_d, &m_d, m_d, m_d); 
	MessageBox(buf); 
}
