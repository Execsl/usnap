...
#if !defined(AFX_COMMANDS_H__B65376FC_30B0_41AA_B3BD_2C5A6A32827F__INCLUDED_)
#define AFX_COMMANDS_H__B65376FC_30B0_41AA_B3BD_2C5A6A32827F__INCLUDED_

#include "addin1Types.h"

class CCommands : 
	public CComDualImpl<ICommands, &IID_ICommands, &LIBID_Addin1>, 
...
protected:
	...
	class XApplicationEvents : public XEventHandler<IApplicationEvents, 
		&IID_IApplicationEvents, &LIBID_Addin1, 
	...
	class XDebuggerEvents : public XEventHandler<IDebuggerEvents, 
		&IID_IDebuggerEvents, &LIBID_Addin1, 
...
public:
// ICommands methods
	STDMETHOD(Addin1CommandMethod)(THIS);
};
...
#endif // !defined(AFX_COMMANDS_H__B65376FC_30B0_41AA_B3BD_2C5A6A32827F__INCLUDED)
