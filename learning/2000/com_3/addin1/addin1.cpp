// addin1.cpp : Defines the initialization routines for the DLL.
//
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CAddin1App object

CAddin1App theApp;

/////////////////////////////////////////////////////////////////////////////
// CAddin1App construction

CAddin1App::CAddin1App()
{
...
STDAPI DllRegisterServer(void)
{
	...
	if (lRes == ERROR_SUCCESS)
	{
		...
		if (lRes == ERROR_SUCCESS)
		{
			...
			strDescription.LoadString(IDS_ADDIN1_DESCRIPTION);
