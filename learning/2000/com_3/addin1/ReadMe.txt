========================================================================
       DEVELOPER STUDIO ADD-IN : addin1
========================================================================


The Add-in Wizard has created this addin1 DLL for you.  This DLL not only
...
addin1.cpp
	This is the main DLL source file.  It contains the class CAddin1App.
...
Commands.cpp, Commands.h
    ...
    a sample command (Addin1Command) which displays a message
...
StdAfx.h, StdAfx.cpp
    ...
    named addin1.pch and a precompiled types file named StdAfx.obj.
