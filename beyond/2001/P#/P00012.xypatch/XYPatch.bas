Attribute VB_Name = "modXYPatch"
Option Explicit

Global Const XYSign = "桃壳软件翔宇打补丁专家补丁文件1.00"

Global Const XYDir = "目录:", XYDirX = "目录结束"
Global Const XYArt = "文档:", XYArtX = "文档结束"
Global Const XYPatch = "补丁:", XYPatchX = "补丁结束"
' 补丁间分割符  [00A95C70[/生命值][/1000[bWd][tF]][/1.0]] ...
Global Const XYPatchLL = "[", XYPatchLR = "]"

Global Const XYEnd = "全部结束"

Global Const XYDataInline = "内嵌数据", XYDataInlineX = "内嵌数据结束"

' 用在TagData.Src数据中
Global Const XYFileRefer = "&"
