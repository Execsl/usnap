========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : ole
========================================================================


AppWizard has created this ole application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your ole application.
...
res\ole.ico
    ...
    icon is included by the main resource file ole.rc.
...
oleDlg.h, oleDlg.cpp - the dialog
    These files contain your COleDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in ole.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your COleDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named ole.pch and a precompiled types file named StdAfx.obj.
