...
class CeLIDevice : 
	...
	public CComCoClass<CeLIDevice, &CLSID_CeLIDevice>, 
	public IDispatchImpl<ICeLIDevice, &IID_ICeLIDevice> {
public: 
	CeLIDevice(); 
	virtual ~CeLIDevice(); 
...
public: 
	BEGIN_COM_MAP(CeLIDevice)
		COM_INTERFACE_ENTRY2(IDispatch, ICeLIDevice)
		COM_INTERFACE_ENTRY(ICeLIDevice)
	END_COM_MAP()

	DECLARE_REGISTRY_RESOURCEID(IDR_CeLiImages)
	DECALRE_NOT_AGGREGATABLE(CeLIDevice);
