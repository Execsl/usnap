...
#define MODFS_VER "modfs $Revision: 1.4 $"
...
static nscmd_t modfs_cmds[] = {
    ...
    { "ls", 0, modfs_ls,                /* ls([path], [options]) */
      NULL, 0, { NSTYPE_STRING, NSTYPE_STRING }, 2,
      NULL, 0, 0, 
      "ls [<path> [-<options>]]\n"
    ...
    { "mv", 0, modfs_mv,                /* mv(path1, path2) */
      { NSTYPE_STRING, NSTYPE_STRING }, 2, NULL, 0,
      NULL, 0, 0, 
